...
func _input(event):
	...
	if Input.is_action_just_pressed("ui_select") and item_active:
		...
		get_id()
		item_active = false
		if item_id == "Yummy Cake" or item_id == "Bounty Herb" or item_id == "Sugar Pill" or item_id == "Ginger Tea" or item_id == "Flummery Flambe" or item_id == "Saffron Souffle" or item_id == "Polar Parfait" or item_id == "Nori Cookie" or item_id == "Starberry" or item_id == "Hocus Potion" or item_id == "Magic Mushroom" or item_id == "Delicious Cake" or item_id == "Amazing Cake" or item_id == "Icescream":
