...
var Item_Choice = ["Yummy Cake", "Pretty Gem", "Picnic Pie", "Bounty Herb", "Polar Parfait", "Spikey Bomb", "Yummy Cake", "Pretty Gem", "Picnic Pie", "Bounty Herb", "Polar Parfait", "Spikey Bomb", "Yummy Cake", "Pretty Gem", "Picnic Pie", "Bounty Herb", "Polar Parfait", "Spikey Bomb", "Hocus Potion", "Magic Mushroom", "Jinx Doll", "Remedy Bouquet", "Strange Perfume", "Faulty Amp", "Power Drill", "Chilly Globe", "Blister Grenade", "Delicious Cake", "Lovely Gem", "Strange Perfume", "Flummery Flambe", "Saffron Souffle", "Nori Cookie", "Ginger Tea", "Sugar Pill", "Yummy Cake", "Yummy Cake", "Picnic Pie", "Bounty Herb", "Polar Parfait", "Spikey Bomb", "Yummy Cake", "Yummy Cake", "Picnic Pie", "Bounty Herb", "Polar Parfait", "Picnic Pie", "Yummy Cake", "Picnic Pie", "Spikey Bomb"]
